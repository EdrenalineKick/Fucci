/*
 * TestFucciAdhesion.hpp
 *
 *  Created on: 2 Nov 2017
 *      Author: edward
 */

#ifndef PROJECTS_FUCCI_TEST_TESTFUCCIADHESION_HPP_
#define PROJECTS_FUCCI_TEST_TESTFUCCIADHESION_HPP_
...
class TestFucciAdhesion : public AbstractCellBasedTestSuite
{
public:
	void TestAdhesion()
	{
		...
		//generate mesh
		HoneycombMeshGenerator generator(50,50,2);
...
//		}
		...
		simulator.SetOutputDirectory("SamStuff");
...
#endif /* PROJECTS_FUCCI_TEST_TESTFUCCIADHESION_HPP_ */
